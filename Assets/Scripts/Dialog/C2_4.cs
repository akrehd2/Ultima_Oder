        ...
        if (DialogSystem.instance.day == 3)
        {
            ...
            if (DialogSystem.instance.Result == 0)
            {
                ...
                if (DialogSystem.instance.Rang == 0)
                {
                    ...
                    dialogTexts.Add(new DialogData("/sound:Perfect2//emote:Perfect//size:up/This is it! This is it!", "앤"));
                ...
                else
                {
                    ...
                    dialogTexts.Add(new DialogData("/sound:Perfect2//emote:Perfect//size:up/바로 이거에요, 이거!", "앤"));
            ...
            else if (DialogSystem.instance.Result == 1)
            {
                if (DialogSystem.instance.Rang == 0)
                {
                    ...
                    dialogTexts.Add(new DialogData("/sound:Great2//emote:Great//speed:0.06/Um~ It's good.", "앤"));
                ...
                else
                {
                    ...
                    dialogTexts.Add(new DialogData("/sound:Great2//emote:Great//speed:0.06/음~ 좋아요.", "앤"));
            ...
            else if (DialogSystem.instance.Result == 2 || DialogSystem.instance.Result == 3)
            {
                ...
                if (DialogSystem.instance.Rang == 0)
                {
                    ...
                    dialogTexts.Add(new DialogData("/sound:woo//emote:Sad//speed:0.06/I don't think I can fix my grandson's picky eating with this..", "앤"));
                ...
                else
                {
                    ...
                    dialogTexts.Add(new DialogData("/sound:woo//emote:Sad//speed:0.06/이걸로 손주 편식 고치긴 힘들 것 같네요..", "앤"));
